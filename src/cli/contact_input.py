...
class ContactInfoCollector:
    ...
    def collect_contact_info_for_heirs(
        ...
        console.print(Panel.fit(
            "[bold cyan]相続人の連絡先情報入力[/bold cyan]",
            border_style="cyan"
        ))
        console.print()
        ...
        for heir in result.heirs:
            console.print()
            console.print(f"[bold green]【{heir.person.name}】の連絡先情報[/bold green]")
            console.print()
        ...
        if updated_persons:
            console.print()
            console.print(f"[bold green]✓ {len(updated_persons)}名の連絡先情報を登録しました[/bold green]")

        return updated_persons

    def prompt_email(self, person_name: str) -> Optional[str]:
        ...
        while True:
            ...
            if self._validate_email(email):
                ...
                console.print("[red]メールアドレスの形式が正しくありません（例: example@example.com）[/red]")
    ...
    def display_contact_summary(self, persons: List[Person]) -> None:
        ...
        console.print()
        console.print(Panel.fit(
            "[bold cyan]登録された連絡先情報[/bold cyan]",
            border_style="cyan"
        ))
        console.print()
